...
## Features
* **Trending Movies:** Displays a weekly updated list of popular films using a responsive grid layout.
* **Search Functionality:** Allows users to find any movie by title via the TMDB Search API.
* **Detailed View:** Shows high-quality posters, ratings, release dates, and synopses.
...
1.  **Browsing:** Users start on the Home tab, scrolling through trending posters.
2.  **Searching:** Users can switch to the Search tab to find specific movies.
